    ...
    stopInfinityRecord() {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.idleRec.once('error', error => {
                ...
                reject(new CustomError('*Voice Controller stopInfinityRecord failed: ', error));
            });
        });
    }
    //////////////////////////////////////////////////////////////////////////////
        ...
        return new Promise((resolve, reject) => {
            try {
                ...
                this.idleRec.once('REC_failed', error => {
                    release();
                    reject(new CustomError('*Voice Controller idlePhase failed: ', error));
                });
                ...
                this.idleRec.on('frame', frame => {
                    try {
                        ...
                        this.idleRec.emit('REC_failed', new CustomError('*Frame processing failed: ', error));
                    }
                });
        ...
        return new Promise((resolve, reject) => {
            try {
                ...
                this.sttRec.once('REC_failed', error => {
                    release();
                    reject(new CustomError('*Voice Controller recordPhase failed: ', error));
                });
                ...
                this.sttRec.on('frame', frame => {
                    try {
                        ...
                        this.sttRec.emit('REC_failed', new CustomError('*Frame processing failed: ', error));
                    }
                });
    ...
    async waitPhase() {
        ...
        return new Promise((resolve, reject) => {
            try {
                ...
                reject(new CustomError('*Voice Controller waitPhase failed: ', error));
            }
        });
    }
    //////////////////////////////////////////////////////////////////////////////
    async compositeRecordPhase() {
        ...
        return new Promise((resolve, reject) => {
            try {
                ...
                this.sttRec.once('REC_failed', error => {
                    release();
                    reject(new CustomError('*Voice Controller compositeRecordPhase failed: ', error));
                });
                this.sttRec.once('REC_cant_read', () => {
                    release();
                    reject(new CustomError('*Voice Controller compositeRecordPhase failed: ', error));
