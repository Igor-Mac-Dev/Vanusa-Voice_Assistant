...
1. [Click here](https://github.com/Igor-Mac-Dev/Vanusa-Voice_Assistant/blob/main/Vanusa_installer.cmd) to download the installer, then run it as admin. (The installer
